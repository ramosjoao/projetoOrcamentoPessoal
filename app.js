...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('modalAcao').innerHTML = 'Voltar'
        document.getElementById('modalAcao').className = 'btn btn-success'
        ...
        document.getElementById('modalAcao').innerHTML = 'Voltar e corrigir'
        document.getElementById('modalAcao').className = 'btn btn-danger'
